...
function crash_attach_ped(model_name,pid)
     ...
     while not STREAMING.HAS_MODEL_LOADED(hash) do
         ...
         attach = util.create_ped(28 ,hash, ENTITY.GET_ENTITY_COORDS(V3, true), CAM.GET_FINAL_RENDERED_CAM_ROT(64).z)
		 attach2 = util.create_ped(29 ,hash, ENTITY.GET_ENTITY_COORDS(V3, true), CAM.GET_FINAL_RENDERED_CAM_ROT(64).z)
 ...
 function crash_attach_veh(model_name,pid)
     ...
     if STREAMING.IS_MODEL_A_VEHICLE(hash) then
		...
		while not STREAMING.HAS_MODEL_LOADED(hash) do
         ...
         attach = util.create_vehicle(hash, ENTITY.GET_ENTITY_COORDS(V3, true), CAM.GET_FINAL_RENDERED_CAM_ROT(64).z)
...
menu.toggle(parent,"The Tsar Bomba", {}, "Falling-edge toggle for entity spamming the targeted player, from testing it will spawn 1 NPC on the rising-edge, and spam on the falling-edge.", function(on) -- This function creates the button inside Stand
		...
		ped_hash = util.joaat(ped_name1)
		   ...
		   ped_to_attach = util.create_ped(28, ped_hash, ENTITY.GET_ENTITY_COORDS(V3, true), CAM.GET_FINAL_RENDERED_CAM_ROT(64).z)
